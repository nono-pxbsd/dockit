...
### Fixed
- **Critical fix**: Module update script was failing silently due to incorrect `Module::isEnabled()` call without required parameter. All module updates now work correctly.
